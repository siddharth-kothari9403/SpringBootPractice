package com.example.springSecurityFinalDemo.security;
...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        //to display your own login form
        ...
        //this displays the custom form login page, handles logout and shows the exception page in case a user is denied permission
        return http.build();
    }
}
